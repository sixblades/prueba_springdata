...
/* globals angular, $*/
'use strict';
angular.module('mentoringApp').directive('passwordStrengthBar', function () {
    return {
        replace: true,
        restrict: 'E',
        ...
        link: function link(scope, iElement, attr) {
            var strength = {
                ...
                mesureStrength: function mesureStrength(p) {
...
//# sourceMappingURL=password.directive.js.map
